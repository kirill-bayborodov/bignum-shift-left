...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/kirill-bayborodov/bignum-shift-left?label=release)](https://github.com/kirill-bayborodov/bignum-shift-left/releases/latest)
...
```bash
gcc your_app.c build/bignum_shift_left.o -I./include -I./libs/bignum-common/include -o your_app -no-pie
```	
