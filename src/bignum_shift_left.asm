...
; @return     rax: Указатель на статическую строку с версией.
; =============================================================================
global bignum_shift_left_get_version_string
bignum_shift_left_get_version_string:
    mov     rax, version_string
    ret

; =============================================================================
; @brief      Возвращает числовое представление версии библиотеки.
; @return     eax: Числовое представление версии (0x010000).
; =============================================================================
global bignum_shift_left_get_version_number
bignum_shift_left_get_version_number:
    mov     eax, 0x010000
    ret
...
section .data
    version_string: db "bignum_shift_left 1.0.0 (asm)", 0
